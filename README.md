...
| `solution-architect` | Solution-architecture toolkit: interview-driven architecture documentation with interactive diagrams and provenance-tagged facts, AI-aware project estimation, and client-ready proposals.    | 2.0.1   |
...
- **[review-architecture](./plugins/solution-architect/skills/review-architecture/SKILL.md)** (`solution-architect`) — Independent review of a finished architecture package: findings with evidence, counted coverage ratios, and one readiness verdict; triggers on asks to review, audit, or sanity-check architecture docs or an ADR. Writes `review-report.md` and never edits what it reviews.
